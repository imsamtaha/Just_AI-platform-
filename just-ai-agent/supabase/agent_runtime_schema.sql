...
create policy "Users select own agent sessions" on public.agent_sessions for select to authenticated using ((select auth.uid()) = user_id);
drop policy if exists "Users insert own agent sessions" on public.agent_sessions;
create policy "Users insert own agent sessions" on public.agent_sessions for insert to authenticated with check ((select auth.uid()) = user_id);
drop policy if exists "Users update own agent sessions" on public.agent_sessions;
create policy "Users update own agent sessions" on public.agent_sessions for update to authenticated using ((select auth.uid()) = user_id) with check ((select auth.uid()) = user_id);
drop policy if exists "Users delete own agent sessions" on public.agent_sessions;
create policy "Users delete own agent sessions" on public.agent_sessions for delete to authenticated using ((select auth.uid()) = user_id);

drop policy if exists "Users select own agent executions" on public.agent_executions;
create policy "Users select own agent executions" on public.agent_executions for select to authenticated using ((select auth.uid()) = user_id);
drop policy if exists "Users insert own agent executions" on public.agent_executions;
create policy "Users insert own agent executions" on public.agent_executions for insert to authenticated with check ((select auth.uid()) = user_id and exists (select 1 from public.agent_sessions s where s.id = session_id and s.user_id = (select auth.uid())));
drop policy if exists "Users delete own agent executions" on public.agent_executions;
create policy "Users delete own agent executions" on public.agent_executions for delete to authenticated using ((select auth.uid()) = user_id);

drop policy if exists "Users select own agent skill usage" on public.agent_skill_usage;
create policy "Users select own agent skill usage" on public.agent_skill_usage for select to authenticated using ((select auth.uid()) = user_id);
drop policy if exists "Users insert own agent skill usage" on public.agent_skill_usage;
create policy "Users insert own agent skill usage" on public.agent_skill_usage for insert to authenticated with check ((select auth.uid()) = user_id and exists (select 1 from public.agent_executions e where e.id = execution_id and e.user_id = (select auth.uid())));
drop policy if exists "Users delete own agent skill usage" on public.agent_skill_usage;
create policy "Users delete own agent skill usage" on public.agent_skill_usage for delete to authenticated using ((select auth.uid()) = user_id);

drop policy if exists "Users select own agent memories" on public.agent_memories;
create policy "Users select own agent memories" on public.agent_memories for select to authenticated using ((select auth.uid()) = user_id);
drop policy if exists "Users insert own agent memories" on public.agent_memories;
create policy "Users insert own agent memories" on public.agent_memories for insert to authenticated with check ((select auth.uid()) = user_id and (session_id is null or exists (select 1 from public.agent_sessions s where s.id = session_id and s.user_id = (select auth.uid()))));
drop policy if exists "Users update own agent memories" on public.agent_memories;
create policy "Users update own agent memories" on public.agent_memories for update to authenticated using ((select auth.uid()) = user_id) with check ((select auth.uid()) = user_id and (session_id is null or exists (select 1 from public.agent_sessions s where s.id = session_id and s.user_id = (select auth.uid()))));
drop policy if exists "Users delete own agent memories" on public.agent_memories;
create policy "Users delete own agent memories" on public.agent_memories for delete to authenticated using ((select auth.uid()) = user_id);
